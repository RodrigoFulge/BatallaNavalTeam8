import random, math
#Versión 5.0 - Uso de comprensión de diccionarios para agilizar el código de asignación de coordenadas
BalanceIntentos = 1.5 
...
#Nota: Favor de agregar comprobaciones para que el usuario solo pueda introducir números y para que no se puedan generar
#dos barcos en el mismo espacio
